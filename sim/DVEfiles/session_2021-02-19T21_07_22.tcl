...
# DVE reload session
# Saved on Fri Feb 19 21:07:22 2021
# Designs open: 1
...
catch {gui_list_select -id ${Hier.1} {tb_tcm_riscv_top.UUT_RISCV_SOC.u_tcm_i}}
gui_view_scroll -id ${Hier.1} -vertical -set 0
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*axi_araddr*}
gui_list_show_data -id ${Data.1} {tb_tcm_riscv_top.UUT_RISCV_SOC.u_tcm_i}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {tb_tcm_riscv_top.UUT_RISCV_SOC.u_tcm_i.axi_araddr_i }}
...
gui_wv_zoom_timerange -id ${Wave.1} 248285 275806
...
gui_marker_move -id ${Wave.1} {C1} 261876
