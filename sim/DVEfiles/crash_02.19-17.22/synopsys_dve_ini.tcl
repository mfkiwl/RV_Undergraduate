...
gui_set_state_value -category Globals -key recent_sessions -value {{gui_load_session -ignore_errors -file /home/uho/workspace/RISCV_RTL_SIM/sim/DVEfiles//crash_02.19-17.22/dve_session02.19-17.22.tcl} {gui_load_session -ignore_errors -file /home/uho/workspace/RISCV_RTL_SIM/sim/DVEfiles//crash_02.19-14.53/dve_session02.19-14.53.tcl} {gui_load_session -ignore_errors -file /home/uho/workspace/RISCV_RTL_SIM/sim/DVEfiles//crash_02.19-14.01/dve_session02.19-14.01.tcl}}

# Layout
gui_set_state_value -category Layout -key child_console_size_x -value 1853
...
gui_set_state_value -category Layout -key child_data_size_x -value 420
gui_set_state_value -category Layout -key child_data_size_y -value 797
...
gui_set_state_value -category Layout -key child_hier_size_x -value 328
gui_set_state_value -category Layout -key child_hier_size_y -value 797
...
gui_set_state_value -category Layout -key child_schematic_size_x -value 1107
gui_set_state_value -category Layout -key child_schematic_size_y -value 790
...
gui_set_state_value -category Layout -key child_source_size_x -value 1107
gui_set_state_value -category Layout -key child_source_size_y -value 790
...
gui_set_state_value -category Layout -key child_wave_right -value 1312
...
gui_set_state_value -category Layout -key main_pos_x -value 65
gui_set_state_value -category Layout -key main_pos_y -value 554
gui_set_state_value -category Layout -key main_size_x -value 1916
gui_set_state_value -category Layout -key main_size_y -value 1599
...
gui_set_state_value -category Layout -key stand_wave_child_size_x -value 1860
gui_set_state_value -category Layout -key stand_wave_child_size_y -value 976
...
gui_set_state_value -category Layout -key stand_wave_top_size_y -value 1602
...
# Widget_History
gui_create_state_key -category Widget_History -key Find|m_pFindFrame|m_pFindCombo -value_type string -value {AXI_c_araddr axi_araddr_o axi_rdata_i axi_rddata_i axi_rddatta_i}
gui_create_state_key -category Widget_History -key TopLevel.1|qt_top_dock|&Edit|FindCombo -value_type string -value {AXI_c_araddr axi_araddr_o axi_rdata_i axi_rddata_i axi_rddatta_i}
...
gui_create_state_key -category Widget_History -key TopLevel.2|qt_top_dock|&Edit|FindCombo -value_type string -value {AXI_c_araddr axi_araddr_o axi_rdata_i axi_rddata_i axi_rddatta_i}
