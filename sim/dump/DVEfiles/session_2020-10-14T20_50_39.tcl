...
# DVE full session
# Saved on Wed Oct 14 20:50:39 2020
# Designs open: 1
#   V1: /home/kch/work/TDRAM/Device_top_rtl_sim_env/sim/dump/Dev_top_test_org.vpd
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2427 354} {4272 1399}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 488} {height 822} {dock_state left} {dock_on_new_line true} {child_hier_colhier 492} {child_hier_coltype 216} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 612} {height 822} {dock_state left} {dock_on_new_line true} {child_data_colvariable 360} {child_data_colvalue 224} {child_data_coltype 202} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1845} {height 142} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/kch/work/TDRAM/Device_top_rtl_sim_env/sim/dump/Dev_top_test_org.vpd}] } {
	gui_open_db -design V1 -file /home/kch/work/TDRAM/Device_top_rtl_sim_env/sim/dump/Dev_top_test_org.vpd -nosource
}
...
gui_set_radix -radix {binary} -signals {{V1:testbench.U0_DEVICE.U0_CHIP_TOP.BANK[0].U0_BANK_TOP.BFLOAT16_ALU[0].BFLOAT_ALU.U0_ADD_STAGE.in_acc_mant}}
gui_set_radix -radix {unsigned} -signals {{V1:testbench.U0_DEVICE.U0_CHIP_TOP.BANK[0].U0_BANK_TOP.BFLOAT16_ALU[0].BFLOAT_ALU.U0_ADD_STAGE.in_acc_mant}}
gui_set_radix -radix {binary} -signals {{V1:testbench.U0_DEVICE.U0_CHIP_TOP.BANK[0].U0_BANK_TOP.BFLOAT16_ALU[0].BFLOAT_ALU.U0_ADD_STAGE.mantissa_ADD_temp}}
gui_set_radix -radix {unsigned} -signals {{V1:testbench.U0_DEVICE.U0_CHIP_TOP.BANK[0].U0_BANK_TOP.BFLOAT16_ALU[0].BFLOAT_ALU.U0_ADD_STAGE.mantissa_ADD_temp}}

# Global: Highlighting
gui_highlight_signals -color #006400 {{testbench.U0_DEVICE.U0_CHIP_TOP.BANK[0].U0_BANK_TOP.BFLOAT16_ALU[0].BFLOAT_ALU.U0_ADD_STAGE.mul_aligned_mant[15:0]}}
...
gui_list_set_filter -id ${Data.1} -text {*debug*}
